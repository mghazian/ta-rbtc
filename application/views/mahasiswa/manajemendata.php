            ...
            <div class="standard-form">
                ...
                <div class="standard-form-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="judul" class="form-control" placeholder="" value="<?php echo $poster['judul_publikasi']; ?>" required>
                    </div>

                    <div class="form-group">
                        <label for="nama">Nama Author </label>
                        <input type="text" name="nama" class="form-control" placeholder="" value="<?php echo $poster['nama_penulis']; ?>" required>
                    </div>

                    <div class="form-group">
                        <label for="nama">NRP Author </label>
                        <input type="text" name="nrp" class="form-control" placeholder="" value="<?php echo $poster['nrp_penulis']; ?>" required>
                    </div>

                    <div class="form-group">
                        <label for="tahun">Tahun Publikasi </label>
                        <input type="text" name="tahun" class="form-control" placeholder="" value="<?php echo $poster['tahun_publikasi']; ?>" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="keyword" class="form-control" placeholder="Kata kunci 1, Kata kunci 2, Kata kunci 3, ..." value="<?php echo $poster['kata_kunci']; ?>">
                    </div>

                    <div class="form-group">
                        <label for="dosbing_1">Pembimbing 1</label>
                        <input type="text" name="dosbing_1" class="form-control" placeholder="" value="<?php echo $poster['dosbing_1']; ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="dosbing_2">Pembimbing 2</label>
                        <input type="text" name="dosbing_2" class="form-control" placeholder="" value="<?php echo $poster['dosbing_2']; ?>">
                    </div>
